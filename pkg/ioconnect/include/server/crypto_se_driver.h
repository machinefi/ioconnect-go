...
#include "include/server/crypto_driver_common.h"
...
#if defined(__DOXYGEN_ONLY__) || !defined(IOTEX_PSA_CRYPTO_SE_C)
...
#endif /* __DOXYGEN_ONLY__ || !IOTEX_PSA_CRYPTO_SE_C */
...
typedef enum
{
    ...
    /** A key is being registered with iotex_psa_register_se_key().
     *
