...
typedef enum
{
    ...
    IOTEX_ECP_DP_SECP192R1,      /*!< Domain parameters for the 192-bit curve defined by FIPS 186-4 and SEC1. */
    IOTEX_ECP_DP_SECP224R1,      /*!< Domain parameters for the 224-bit curve defined by FIPS 186-4 and SEC1. */
    IOTEX_ECP_DP_SECP256R1,      /*!< Domain parameters for the 256-bit curve defined by FIPS 186-4 and SEC1. */
    IOTEX_ECP_DP_SECP384R1,      /*!< Domain parameters for the 384-bit curve defined by FIPS 186-4 and SEC1. */
    IOTEX_ECP_DP_SECP521R1,      /*!< Domain parameters for the 521-bit curve defined by FIPS 186-4 and SEC1. */
 ...
 */
int iotex_ecp_check_budget( const iotex_ecp_group *grp,
                              iotex_ecp_restart_ctx *rs_ctx,
                              unsigned ops );

/* Utility macro for checking and updating ops budget */
#define IOTEX_ECP_BUDGET( ops )   \
    IOTEX_MPI_CHK( iotex_ecp_check_budget( grp, rs_ctx, \
                                               (unsigned) (ops) ) );
 ...
 */
int iotex_ecp_group_copy( iotex_ecp_group *dst,
                            const iotex_ecp_group *src );
 ...
 */
int iotex_ecp_point_cmp( const iotex_ecp_point *P,
                           const iotex_ecp_point *Q );
 ...
 */
int iotex_ecp_point_read_string( iotex_ecp_point *P, int radix,
 ...
 * \return          Another negative error code on other kinds of failure.
 */
int iotex_ecp_point_write_binary( const iotex_ecp_group *grp,
 ...
 */
int iotex_ecp_point_read_binary( const iotex_ecp_group *grp,
                                   iotex_ecp_point *P,
 ...
 */
int iotex_ecp_tls_read_point( const iotex_ecp_group *grp,
                                iotex_ecp_point *pt,
 ...
 * \return          Another negative error code on other kinds of failure.
 */
int iotex_ecp_tls_write_point( const iotex_ecp_group *grp,
 ...
 * \return          Another negative error code on other kinds of failure.
 */
int iotex_ecp_tls_read_group( iotex_ecp_group *grp,
                                const unsigned char **buf, size_t len );
 ...
 * \return          Another negative error code on other kinds of failure.
 */
int iotex_ecp_tls_read_group_id( iotex_ecp_group_id *grp,
 ...
 * \return          Another negative error code on other kinds of failure.
 */
int iotex_ecp_tls_write_group( const iotex_ecp_group *grp,
                                 size_t *olen,
                                 unsigned char *buf, size_t blen );
 ...
 * \return          Another negative error code on other kinds of failure.
 */
int iotex_ecp_mul( iotex_ecp_group *grp, iotex_ecp_point *R,
 ...
 * \return          Another negative error code on other kinds of failure.
 */
int iotex_ecp_mul_restartable( iotex_ecp_group *grp, iotex_ecp_point *R,
             const iotex_mpi *m, const iotex_ecp_point *P,
             int (*f_rng)(void *, unsigned char *, size_t), void *p_rng,
             iotex_ecp_restart_ctx *rs_ctx );
 ...
 * \return          Another negative error code on other kinds of failure.
 */
int iotex_ecp_muladd( iotex_ecp_group *grp, iotex_ecp_point *R,
             const iotex_mpi *m, const iotex_ecp_point *P,
             const iotex_mpi *n, const iotex_ecp_point *Q );
 ...
 * \return          Another negative error code on other kinds of failure.
 */
int iotex_ecp_muladd_restartable(
             iotex_ecp_group *grp, iotex_ecp_point *R,
             const iotex_mpi *m, const iotex_ecp_point *P,
             const iotex_mpi *n, const iotex_ecp_point *Q,
             iotex_ecp_restart_ctx *rs_ctx );
 ...
 * \return          Another negative error code on other kinds of failure.
 */
int iotex_ecp_check_pubkey( const iotex_ecp_group *grp,
                              const iotex_ecp_point *pt );
 ...
 * \return          Another negative error code on other kinds of failure.
 */
int iotex_ecp_check_privkey( const iotex_ecp_group *grp,
                               const iotex_mpi *d );
 ...
 *                  on failure.
 */
int iotex_ecp_gen_privkey( const iotex_ecp_group *grp,
                     iotex_mpi *d,
 ...
 *                  on failure.
 */
int iotex_ecp_gen_keypair_base( iotex_ecp_group *grp,
                                  const iotex_ecp_point *G,
 ...
 *                  on failure.
 */
int iotex_ecp_gen_keypair( iotex_ecp_group *grp, iotex_mpi *d,
                             iotex_ecp_point *Q,
                             int (*f_rng)(void *, unsigned char *, size_t),
                             void *p_rng );
 ...
 */
int iotex_ecp_check_pub_priv(
        const iotex_ecp_keypair *pub, const iotex_ecp_keypair *prv,
        int (*f_rng)(void *, unsigned char *, size_t), void *p_rng );
