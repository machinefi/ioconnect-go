 ...
 *       drivers.
 *
 * The PSA core calls iotex_psa_mac_sign_setup() or
 * iotex_psa_mac_verify_setup() before calling this function.
 *
 * If this function returns an error status, the PSA core aborts the
 * operation by calling iotex_psa_mac_abort().
 *
 ...
 *       drivers.
 *
 * The PSA core calls iotex_psa_mac_sign_setup() before calling this function.
 * This function calculates the MAC of the message formed by concatenating
 * the inputs passed to preceding calls to iotex_psa_mac_update().
 *
 * Whether this function returns successfully or not, the PSA core subsequently
 * aborts the operation by calling iotex_psa_mac_abort().
 *
 * \param[in,out] operation Active MAC operation.
 * \param[out] mac          Buffer where the MAC value is to be written.
 ...
 *                          iotex_psa_mac_sign_setup(). It also guarantees the
 ...
 *
 * The PSA core calls iotex_psa_mac_verify_setup() before calling this
 * function. This function calculates the MAC of the message formed by
 * concatenating the inputs passed to preceding calls to
 * iotex_psa_mac_update(). It then compares the calculated MAC with the
 ...
 * iotex_psa_mac_sign_setup() or iotex_psa_mac_verify_setup() again.
 *
 ...
 *
 * In particular, calling iotex_psa_mac_abort() after the operation has been
 * terminated by a call to iotex_psa_mac_abort(),
 * iotex_psa_mac_sign_finish() or iotex_psa_mac_verify_finish() is safe and
 * has no effect.
 *
