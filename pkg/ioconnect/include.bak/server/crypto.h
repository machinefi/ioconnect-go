...
#include "include/server/crypto_platform.h"
...
#include "include/server/crypto_types.h"
...
#include "include/server/crypto_values.h"
...
typedef time_t (*iotex_psa_get_ts_func)(void);
typedef uint32_t (*iotex_psa_entroy_inject)(uint32_t);
...
#include "include/server/crypto_sizes.h"

/* The file "crypto_struct.h" contains definitions for
 * implementation-specific structs that are declared above. */
#include "include/server/crypto_struct.h"

/* The file "crypto_extra.h" contains vendor-specific definitions. This
 * can include vendor-defined algorithms, extra functions, etc. */
#include "include/server/crypto_extra.h"
