...
#define IOTEX_SVC_KEY_ID_INIT ( (psa_key_id_t)0 )
#define IOTEX_SVC_KEY_ID_GET_KEY_ID( id ) ( id )
#define IOTEX_SVC_KEY_ID_GET_OWNER_ID( id ) ( 0 )
 ...
 */
static inline psa_key_id_t iotex_svc_key_id_make(
 ...
 */
static inline int iotex_svc_key_id_equal( psa_key_id_t id1,
                                            psa_key_id_t id2 )
{
    return( id1 == id2 );
}
 ...
 */
static inline int iotex_svc_key_id_is_null( psa_key_id_t key )
{
    return( key == 0 );
}
 ...
 */
#define IOTEX_PSA_ALG_AEAD_EQUAL(aead_alg_1, aead_alg_2) \
